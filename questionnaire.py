...
@app.route("https://github.com/tsuteto-ryb/questionnaire/edit/master/")
def index():
    return render_template('questionnaire-toppage.html')

@app.route("https://github.com/tsuteto-ryb/questionnaire/edit/master/confirmation")
def confirmation():
    if request.form.get('name','') in name_list:
        name=request.form.get('name')
        return redirect(url_for('entry'),name=name)

@app.route("https://github.com/tsuteto-ryb/questionnaire/edit/master/entry")
def entry():
